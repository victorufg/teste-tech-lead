                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('students.update', $student) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="text" name="name" :value="old('name', $student->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="email" name="email" :value="old('email', $student->email)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="birth_date" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="date" name="birth_date" :value="old('birth_date', $student->birth_date)" required />
