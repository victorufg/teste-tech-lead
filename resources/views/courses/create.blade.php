                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('courses.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="text" name="name" :value="old('name')" required autofocus placeholder="Ex: Desenvolvimento Web Completo" />
                        ...
                        <div>
                            ...
                            <select id="type" name="type" class="block mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-primary-500 dark:focus:border-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 shadow-sm py-3 transition-colors">
                                <option value="presential" {{ old('type') == 'presential' ? 'selected' : '' }}>Presencial</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="max_students" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="number" name="max_students" :value="old('max_students')" placeholder="Opcional" />
                            ...
                            <div>
                                ...
                                <x-text-input id="enrollment_deadline" class="block mt-2 w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 transition-colors py-3" type="date" name="enrollment_deadline" :value="old('enrollment_deadline')" required />
