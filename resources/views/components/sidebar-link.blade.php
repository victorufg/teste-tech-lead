...
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-2.5 text-sm font-bold text-slate-900 bg-slate-50 border border-slate-100 rounded-xl transition-all duration-200 shadow-sm'
            : 'flex items-center px-4 py-2.5 text-sm font-medium text-slate-400 hover:text-slate-900 hover:bg-slate-50 rounded-xl border border-transparent transition-all duration-300 group';

$iconClasses = ($active ?? false)
                ? 'w-5 h-5 mr-3.5 text-slate-900'
                : 'w-5 h-5 mr-3.5 text-slate-300 group-hover:text-slate-900 transition-all duration-300';
@endphp
